...
export default function Hero() {
  const words = [
    "Frontend Developer ",
    "React, Tailwind CSS, MongoDB, Node.js enthusiast",
    "Learning MARN Stack",
  ];
...
const profile = {
    name: 'Md. Rayhan',
    title: 'Fronted Developer |React, Tailwind CSS, MongoDB, Node.js enthusiast

',
    skills: [
        'javascript','React',  'Express',
         'MongoDB', 'Node.js', 'Tailwind CSS', 'Bootstrap', 'Firebase'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | React, Tailwind CSS, MongoDB, Node.js
                  enthusiast | Coding the future 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/MohammadRayhan190720" target="_blank"
